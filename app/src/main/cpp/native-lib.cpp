...
Java_com_ilab_opencvtest_MainActivity_ConvertRGBtoGray(JNIEnv *env, jobject thiz,
...
Java_com_ilab_opencvtest_MainActivity_loadCascade(JNIEnv *env, jobject thiz,
...
Java_com_ilab_opencvtest_MainActivity_detect(JNIEnv *env, jobject thiz,
